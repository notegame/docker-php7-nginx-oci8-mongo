...
RUN apt-get update
RUN apt-get install -y libaio1 unzip php7.0-dev
RUN apt-get clean -y
...
RUN echo "extension=oci8.so" > /etc/php/7.0/mods-available/30-oci8.ini
RUN ln -s /etc/php/7.0/mods-available/30-oci8.ini /etc/php/7.0/cli/conf.d/30-oci8.ini
RUN ln -s /etc/php/7.0/mods-available/30-oci8.ini /etc/php/7.0/fpm/conf.d/30-oci8.ini
...
RUN echo "extension=mongodb.so" > /etc/php/7.0/mods-available/30-mongodb.ini
RUN ln -s /etc/php/7.0/mods-available/30-mongodb.ini /etc/php/7.0/cli/conf.d/30-mongodb.ini
RUN ln -s /etc/php/7.0/mods-available/30-mongodb.ini /etc/php/7.0/fpm/conf.d/30-mongodb.ini
